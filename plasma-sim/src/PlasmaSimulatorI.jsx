  ...
  const theorySteps = [
    {
      step: 1,
      title: "플라즈마란 무엇인가?",
      content: "플라즈마는 고체, 액체, 기체에 이어 물질의 '제4상태'로 불립니다. 놀랍게도 우주의 99% 이상이 플라즈마 상태입니다! 태양과 별들이 모두 플라즈마로 이루어져 있기 때문이죠. 지구에서는 번개, 오로라, 네온사인, 형광등 등에서 플라즈마를 볼 수 있습니다. 플라즈마는 기체에 강한 에너지를 가하면 만들어지는데, 이때 원자에서 전자가 떨어져 나와 양이온과 자유전자로 분리됩니다. 반도체 공정에서는 '저온 플라즈마'를 사용하는데, 이는 전자의 온도는 수만 도로 매우 뜨겁지만 이온과 중성입자는 상온에 가까워서 웨이퍼를 손상시키지 않는다는 장점이 있습니다. 마치 뜨거운 전자들이 춤을 추는 동안, 이온들은 차분히 앉아있는 신기한 상태라고 생각하면 됩니다!",
      color: "from-blue-500 to-purple-500"
    },
    {
      step: 2,
      title: "플라즈마의 핵심 특성",
      content: "플라즈마가 특별한 이유는 세 가지 핵심 특성 때문입니다. 첫째, '준중성(Quasi-neutrality)'입니다. 플라즈마 안에는 양이온(+)과 전자(-)가 거의 같은 수로 존재해서 전체적으로는 전기적으로 중성을 유지합니다. 물론 아주 작은 영역에서는 전하의 불균형이 생기지만, 큰 스케일에서 보면 중성이에요. 둘째, '집단 거동(Collective Behavior)'입니다. 일반 기체는 입자들이 제멋대로 움직이지만, 플라즈마는 입자들이 서로 전기적으로 영향을 주고받으며 마치 하나의 집단처럼 움직입니다. 한 입자가 움직이면 주변 입자들도 함께 반응하는 거죠. 셋째, '전기전도성'입니다. 플라즈마에는 자유전자가 많아서 전기가 잘 흐르고, 전자기파와도 상호작용할 수 있습니다. 이 특성 덕분에 플라즈마를 전기장이나 자기장으로 제어할 수 있답니다!",
      color: "from-purple-500 to-pink-500"
    },
    {
      step: 3,
      title: "반도체 공정에서의 플라즈마",
      content: "반도체 칩을 만드는 과정에서 플라즈마는 정말 중요한 역할을 합니다. 크게 세 가지 응용이 있어요. 첫 번째는 '식각(Etching)'입니다. 플라즈마 속의 활성화된 라디칼과 이온들이 웨이퍼 표면을 선택적으로 깎아내서 나노미터 수준의 미세한 패턴을 만듭니다. 마치 초정밀 조각칼처럼 작동하는 거죠. 두 번째는 '증착(Deposition)'입니다. PECVD(Plasma Enhanced Chemical Vapor Deposition)라는 기술로 플라즈마의 높은 반응성을 이용해 저온에서도 고품질의 박막을 형성할 수 있습니다. 예를 들어 절연막이나 보호막을 씌울 때 사용돼요. 세 번째는 '세정(Cleaning)'입니다. 플라즈마 애싱(Ashing)으로 포토레지스트를 제거하거나 웨이퍼 표면의 오염물질을 청정화합니다. 플라즈마를 사용하면 200도 이하의 저온에서도 이 모든 공정을 할 수 있어서, 열에 약한 소재도 안전하게 처리할 수 있답니다!",
      color: "from-pink-500 to-red-500"
    },
    {
      step: 4,
      title: "플라즈마 생성과 제어",
      content: "그렇다면 플라즈마는 어떻게 만들고 제어할까요? 플라즈마를 만드는 기본 원리는 간단합니다. 진공 챔버에 아르곤(Ar), 산소(O2), 불소계 가스(CF4, SF6) 같은 공정 가스를 넣고, 강한 전기장을 걸어주면 됩니다. 전기장이 전자를 가속시키고, 이 고속 전자가 중성 원자와 충돌하면서 새로운 전자를 떼어내는 '눈사태 이온화(Avalanche Ionization)'가 일어나며 플라즈마가 형성됩니다. 여기서 중요한 건 플라즈마를 정밀하게 제어하는 거예요. '압력'을 조절하면 입자들의 충돌 빈도가 바뀌어 플라즈마 밀도가 달라집니다. '전력'을 높이면 더 많은 에너지가 공급되어 이온화율이 증가하죠. 'RF 주파수'를 바꾸면 이온 에너지와 플라즈마의 화학적 특성을 조절할 수 있습니다. 마치 요리할 때 불 세기, 시간, 재료 비율을 조절하듯이, 이 파라미터들을 미세하게 조정해서 우리가 원하는 특성의 플라즈마를 만들어낼 수 있답니다!",
      color: "from-red-500 to-orange-500"
    },
    {
      step: 5,
      title: "저온 플라즈마의 특별함",
      content: "반도체 공정에서 사용하는 저온 플라즈마는 정말 신기한 '비평형 플라즈마'입니다. 일반적으로 온도가 높아지면 모든 입자가 함께 뜨거워지는데, 플라즈마는 다릅니다! 전자의 온도(Te)는 무려 10,000~100,000K(약 1~10 eV)에 달하지만, 이온과 중성입자의 온도(Ti, Tg)는 고작 300~500K(상온~200도)에 불과합니다. 어떻게 이게 가능할까요? 전자는 질량이 매우 작아서(이온의 1/100,000 수준) 전기장에서 빠르게 가속되어 높은 에너지를 얻지만, 무거운 이온이나 중성입자는 천천히 움직이기 때문입니다. 이 놀라운 특성 덕분에 우리는 실리콘 웨이퍼나 유리 같은 열에 민감한 기판을 녹이지 않으면서도, 고에너지 전자들의 강력한 반응성을 활용할 수 있습니다. 마치 뜨거운 커피(전자)를 차가운 컵(기판)에 담을 수 있는 것처럼요! 이것이 바로 플라즈마 공정이 현대 반도체 제조의 핵심 기술이 된 이유랍니다.",
